        ...
        <div id="blog" className="container">
            <div className="blogText">
                ...
                <div className="linkBtns">
                    <button className="twitterBtn"><Twitter/>twitter</button>
                    <button className="linkedinBtn"><Linkin/>linkedin</button>
                    <button className="mediumBtn"><Medium/>medium</button>
                </div>
            </div>
            <div className="blogIll">
                <img src="./images/Rectangle.png" alt="restangle" className="rectangle"></img>
            <img src="./images/Saly-16.png" alt="Saly-16" class="saly"></img>
            </div>
